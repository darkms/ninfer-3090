...
Custom templates use the bundled Minja LLM chat-template renderer and receive the standard
`messages`, `tools`, `add_generation_prompt`, `enable_thinking`, and preservation values.
